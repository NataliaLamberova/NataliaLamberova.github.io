...
## Government R&D policy, Political Constraints and Economic Impact
...
[**“Democratic Backsliding: Civil Society and Institutions under COVID-19**](#works) (paper available upon request)

Under the threat of COVID-19, many countries have imposed rules and regulations that limit individual freedoms, such as the right to assembly or the freedom of speech. Yet citizens chose to accept these limitations, as the power of the state to coerce others to limit public gatherings or prevent the spread of misinformation reduces one's risk to be affected by the disease or the risk that their loved ones would suffer from it. Many states exploited the public mandate to impose anti-pandemic measures by increasing the degree of authoritarian control and weakening the civil society. Using a cross-regional data from 83 Russian regions I show that the degree to which political elites can utilize the tools of authoritarian control - misinformation and repression - depends on the quality of institutions and the strength of civil society. Yet such tactics come at a price to the incumbent: misinformation reduces the willingness of citizens to comply with anti-pandemic measures and backfires in case of opposition mobilization. By contrast, I show that political monopoly makes it easier for regional elites to utilize the tools of authoritarian control.
